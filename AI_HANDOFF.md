...
1. Obtain explicit user authorization to commit/push the validated changes, as required by `AGENTS.md`, then publish through Sites.
2. If the user requests browser testing, verify mobile-width quick controls, shutter, fullscreen entry/exit, path geometry, and captured-pose freeze before or after publication.
3. Record the exact commit and deployment evidence after publication.
