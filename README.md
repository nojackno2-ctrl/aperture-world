...
* **四款專業變焦鏡頭群**：
  * **24–70 mm F2.8**：標準大光圈變焦鏡（適合風景、街拍、環境人像）
  * **70–200 mm F2.8**：望遠大光圈變焦鏡（適合人像特寫、運動舞台）
  * **200–600 mm F5.6–6.3**：超遠攝變焦鏡（適合飛鳥生態、航空追焦）
  * **400–800 mm F6.3–8.0**：極限超遠攝變焦鏡（適合野生動物特寫）
* **中心自動對焦 (AF) 系統**：即時光學測距，提供「小 / 中 / 大」三段可調 AF 框尺寸。
